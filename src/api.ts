...
export const ArtifactsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getContentByGlobalId(globalId: number, references?: HandleReferencesType, options?: RawAxiosRequestConfig): AxiosPromise<File> {
         ...
         * @throws {RequiredError}
         */
        searchArtifacts(name?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: ArtifactSortBy, labels?: Array<string>, description?: string, groupId?: string, globalId?: number, contentId?: number, artifactId?: string, options?: RawAxiosRequestConfig): AxiosPromise<ArtifactSearchResults> {
...
export const VersionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        searchVersions: async (version?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: VersionSortBy, labels?: Array<string>, description?: string, groupId?: string, globalId?: number, contentId?: number, artifactId?: string, name?: string, state?: VersionState, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const VersionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async searchVersions(version?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: VersionSortBy, labels?: Array<string>, description?: string, groupId?: string, globalId?: number, contentId?: number, artifactId?: string, name?: string, state?: VersionState, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VersionSearchResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.searchVersions(version, offset, limit, order, orderby, labels, description, groupId, globalId, contentId, artifactId, name, state, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const VersionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        searchVersions(version?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: VersionSortBy, labels?: Array<string>, description?: string, groupId?: string, globalId?: number, contentId?: number, artifactId?: string, name?: string, state?: VersionState, options?: RawAxiosRequestConfig): AxiosPromise<VersionSearchResults> {
            return localVarFp.searchVersions(version, offset, limit, order, orderby, labels, description, groupId, globalId, contentId, artifactId, name, state, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a paginated list of all versions that match the posted content.  This operation can fail for the following reasons:  * Provided content (request body) was empty (HTTP error `400`) * A server error occurred (HTTP error `500`) 
         * @summary Search for versions by content
...
export class VersionsApi extends BaseAPI {
     ...
     * @memberof VersionsApi
     */
    public searchVersions(version?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: VersionSortBy, labels?: Array<string>, description?: string, groupId?: string, globalId?: number, contentId?: number, artifactId?: string, name?: string, state?: VersionState, options?: RawAxiosRequestConfig) {
        return VersionsApiFp(this.configuration).searchVersions(version, offset, limit, order, orderby, labels, description, groupId, globalId, contentId, artifactId, name, state, options).then((request) => request(this.axios, this.basePath));
    }
