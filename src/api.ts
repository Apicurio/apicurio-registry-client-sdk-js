...
export class ArtifactsApi extends BaseAPI {
    ...
    public referencesByContentHash(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig) {
        return ArtifactsApiFp(this.configuration).referencesByContentHash(UNKNOWN_PARAMETER_NAME, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public referencesByContentId(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig) {
        return ArtifactsApiFp(this.configuration).referencesByContentId(UNKNOWN_PARAMETER_NAME, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public referencesByGlobalId(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig) {
        return ArtifactsApiFp(this.configuration).referencesByGlobalId(UNKNOWN_PARAMETER_NAME, options).then((request) => request(this.axios, this.basePath));
    }
