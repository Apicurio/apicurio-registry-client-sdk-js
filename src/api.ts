...
export const AdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createGlobalRule: async (rule: Rule, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteGlobalRule: async (rule: RuleType, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'rule' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getGlobalRuleConfig: async (rule: RuleType, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'rule' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        importData: async (body: File, xRegistryPreserveGlobalId?: boolean, xRegistryPreserveContentId?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listRoleMappings: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/admin/roleMappings`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        updateGlobalRuleConfig: async (rule: RuleType, rule2: Rule, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'rule' is not null or undefined
...
export const AdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createGlobalRule(rule: Rule, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createGlobalRule(rule, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.createGlobalRule']?.[index]?.url;
        ...
        async createRoleMapping(roleMapping: RoleMapping, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.createRoleMapping']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes all globally configured rules.  This operation can fail for the following reasons:  * A server error occurred (HTTP error `500`) 
        ...
        async deleteAllGlobalRules(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.deleteAllGlobalRules']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes a single global rule.  If this is the only rule configured, this is the same as deleting **all** rules.  This operation can fail for the following reasons:  * Invalid rule name/type (HTTP error `400`) * No rule with name/type `rule` exists (HTTP error `404`) * Rule cannot be deleted (HTTP error `409`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async deleteGlobalRule(rule: RuleType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteGlobalRule(rule, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.deleteGlobalRule']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes a single role mapping, effectively denying access to a user/principal.  This operation can fail for the following reasons:  * No role mapping for the principalId exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async deleteRoleMapping(principalId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.deleteRoleMapping']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Exports registry data as a ZIP archive.
        ...
        async exportData(forBrowser?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.exportData']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns the value of a single configuration property.  This operation may fail for one of the following reasons:  * Property not found or not configured (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getConfigProperty(propertyName: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConfigurationProperty>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.getConfigProperty']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns information about the named globally configured rule.  This operation can fail for the following reasons:  * Invalid rule name/type (HTTP error `400`) * No rule with name/type `rule` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async getGlobalRuleConfig(rule: RuleType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Rule>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getGlobalRuleConfig(rule, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.getGlobalRuleConfig']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the details of a single role mapping (by `principalId`).  This operation can fail for the following reasons:  * No role mapping for the `principalId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getRoleMapping(principalId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RoleMapping>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.getRoleMapping']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Imports registry data that was previously exported using the `/admin/export` operation.
         ...
         * @throws {RequiredError}
         */
        async importData(body: File, xRegistryPreserveGlobalId?: boolean, xRegistryPreserveContentId?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.importData']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets a list of all the configured artifact types.  This operation can fail for the following reasons:  * A server error occurred (HTTP error `500`) 
        ...
        async listArtifactTypes(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactTypeInfo>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.listArtifactTypes']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list of all configuration properties that have been set.  The list is not paged.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`) 
        ...
        async listConfigProperties(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ConfigurationProperty>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.listConfigProperties']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets a list of all the currently configured global rules (if any).  This operation can fail for the following reasons:  * A server error occurred (HTTP error `500`) 
        ...
        async listGlobalRules(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RuleType>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.listGlobalRules']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets a list of all role mappings configured in the registry (if any).  This operation can fail for the following reasons:  * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async listRoleMappings(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RoleMapping>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listRoleMappings(options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.listRoleMappings']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Resets the value of a single configuration property.  This will return the property to its default value (see external documentation for supported properties and their default values).  This operation may fail for one of the following reasons:  * Property not found or not configured (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async resetConfigProperty(propertyName: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.resetConfigProperty']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the value of a single configuration property.  This operation may fail for one of the following reasons:  * Property not found or not configured (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async updateConfigProperty(propertyName: string, updateConfigurationProperty: UpdateConfigurationProperty, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.updateConfigProperty']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the configuration for a globally configured rule.  This operation can fail for the following reasons:  * Invalid rule name/type (HTTP error `400`) * No rule with name/type `rule` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async updateGlobalRuleConfig(rule: RuleType, rule2: Rule, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Rule>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateGlobalRuleConfig(rule, rule2, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.updateGlobalRuleConfig']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates a single role mapping for one user/principal.  This operation can fail for the following reasons:  * No role mapping for the principalId exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async updateRoleMapping(principalId: string, updateRole: UpdateRole, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AdminApi.updateRoleMapping']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export class AdminApi extends BaseAPI {
     ...
     * @memberof AdminApi
     */
    public createGlobalRule(rule: Rule, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AdminApi
     */
    public deleteGlobalRule(rule: RuleType, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AdminApi
     */
    public getGlobalRuleConfig(rule: RuleType, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AdminApi
     */
    public importData(body: File, xRegistryPreserveGlobalId?: boolean, xRegistryPreserveContentId?: boolean, options?: RawAxiosRequestConfig) {
     ...
     * @memberof AdminApi
     */
    public listRoleMappings(options?: RawAxiosRequestConfig) {
     ...
     * @memberof AdminApi
     */
    public updateGlobalRuleConfig(rule: RuleType, rule2: Rule, options?: RawAxiosRequestConfig) {
...
export const ArtifactRulesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createArtifactRule: async (groupId: string, artifactId: string, rule: Rule, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteArtifactRule: async (groupId: string, artifactId: string, rule: DeleteArtifactRuleRuleEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getArtifactRuleConfig: async (groupId: string, artifactId: string, rule: GetArtifactRuleConfigRuleEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        testUpdateArtifact: async (groupId: string, artifactId: string, body: File, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifactRuleConfig: async (groupId: string, artifactId: string, rule: UpdateArtifactRuleConfigRuleEnum, rule2: Rule, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
...
export const ArtifactRulesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createArtifactRule(groupId: string, artifactId: string, rule: Rule, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createArtifactRule(groupId, artifactId, rule, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactRulesApi.createArtifactRule']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes a rule from the artifact.  This results in the rule no longer applying for this artifact.  If this is the only rule configured for the artifact, this is the  same as deleting **all** rules, and the globally configured rules now apply to this artifact.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No rule with this name/type is configured for this artifact (HTTP error `404`) * Invalid rule type (HTTP error `400`) * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async deleteArtifactRule(groupId: string, artifactId: string, rule: DeleteArtifactRuleRuleEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteArtifactRule(groupId, artifactId, rule, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactRulesApi.deleteArtifactRule']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes all of the rules configured for the artifact.  After this is done, the global rules apply to the artifact again.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
        ...
        async deleteArtifactRules(groupId: string, artifactId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactRulesApi.deleteArtifactRules']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns information about a single rule configured for an artifact.  This is useful when you want to know what the current configuration settings are for a specific rule.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No rule with this name/type is configured for this artifact (HTTP error `404`) * Invalid rule type (HTTP error `400`) * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async getArtifactRuleConfig(groupId: string, artifactId: string, rule: GetArtifactRuleConfigRuleEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Rule>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getArtifactRuleConfig(groupId, artifactId, rule, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactRulesApi.getArtifactRuleConfig']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list of all rules configured for the artifact.  The set of rules determines how the content of an artifact can evolve over time.  If no rules are configured for an artifact, the set of globally configured rules are used.  If no global rules  are defined, there are no restrictions on content evolution.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
        ...
        async listArtifactRules(groupId: string, artifactId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RuleType>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactRulesApi.listArtifactRules']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Tests whether an update to the artifact\'s content *would* succeed for the provided content. Ultimately, this applies any rules configured for the artifact against the given content to determine whether the rules would pass or fail, but without actually updating the artifact content.  The body of the request should be the raw content of the artifact.  This is typically in  JSON format for *most* of the supported types, but may be in another format for a few  (for example, `PROTOBUF`).  The update could fail for a number of reasons including:  * Provided content (request body) was empty (HTTP error `400`) * No artifact with the `artifactId` exists (HTTP error `404`) * The new content violates one of the rules configured for the artifact (HTTP error `409`) * The provided artifact type is not recognized (HTTP error `404`) * A server error occurred (HTTP error `500`)  When successful, this operation simply returns a *No Content* response.  This response indicates that the content is valid against the configured content rules for the  artifact (or the global rules if no artifact rules are enabled).
         ...
         * @throws {RequiredError}
         */
        async testUpdateArtifact(groupId: string, artifactId: string, body: File, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.testUpdateArtifact(groupId, artifactId, body, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactRulesApi.testUpdateArtifact']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the configuration of a single rule for the artifact.  The configuration data is specific to each rule type, so the configuration of the `COMPATIBILITY` rule  is in a different format from the configuration of the `VALIDITY` rule.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No rule with this name/type is configured for this artifact (HTTP error `404`) * Invalid rule type (HTTP error `400`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async updateArtifactRuleConfig(groupId: string, artifactId: string, rule: UpdateArtifactRuleConfigRuleEnum, rule2: Rule, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Rule>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateArtifactRuleConfig(groupId, artifactId, rule, rule2, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactRulesApi.updateArtifactRuleConfig']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export class ArtifactRulesApi extends BaseAPI {
     ...
     */
    public createArtifactRule(groupId: string, artifactId: string, rule: Rule, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactRulesApi
     */
    public deleteArtifactRule(groupId: string, artifactId: string, rule: DeleteArtifactRuleRuleEnum, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactRulesApi
     */
    public getArtifactRuleConfig(groupId: string, artifactId: string, rule: GetArtifactRuleConfigRuleEnum, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactRulesApi
     */
    public testUpdateArtifact(groupId: string, artifactId: string, body: File, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactRulesApi
     */
    public updateArtifactRuleConfig(groupId: string, artifactId: string, rule: UpdateArtifactRuleConfigRuleEnum, rule2: Rule, options?: RawAxiosRequestConfig) {
...
export const ArtifactTypeApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async listArtifactTypes(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactTypeInfo>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listArtifactTypes(options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactTypeApi.listArtifactTypes']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const ArtifactsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Array<string>} [xRegistryArtifactBranches] An optional, comma-separated list of artifact branch IDs, that specify branches into which the newly created version will be added. The list may contain a single branch ID, but may not be empty. A new version is always automatically inserted into the \&quot;latest\&quot; branch. If any of the branches do not already exist, they will be created.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createArtifact: async (groupId: string, body: File, xRegistryArtifactType?: string, xRegistryArtifactId?: string, xRegistryVersion?: string, ifExists?: IfExists, canonical?: boolean, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryContentHash?: string, xRegistryHashAlgorithm?: CreateArtifactXRegistryHashAlgorithmEnum, xRegistryArtifactBranches?: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            ...
            if (xRegistryArtifactBranches) {
                let mapped = xRegistryArtifactBranches.map(value => (<any>"Array<string>" !== "Array<string>") ? JSON.stringify(value) : (value || ""));
                localVarHeaderParameter['X-Registry-Artifact-Branches'] = mapped.join(COLLECTION_FORMATS["csv"]);
            }
         ...
         * @throws {RequiredError}
         */
        getLatestArtifact: async (groupId: string, artifactId: string, references?: HandleReferencesType, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listArtifactsInGroup: async (groupId: string, limit?: number, offset?: number, order?: SortOrder, orderby?: SortBy, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        searchArtifacts: async (name?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: SortBy, labels?: Array<string>, properties?: Array<string>, description?: string, group?: string, globalId?: number, contentId?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        searchArtifactsByContent: async (body: File, canonical?: boolean, artifactType?: string, offset?: number, limit?: number, order?: SearchArtifactsByContentOrderEnum, orderby?: SearchArtifactsByContentOrderbyEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifact: async (groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryArtifactBranches?: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifactState: async (groupId: string, artifactId: string, updateState: UpdateState, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
...
export const ArtifactsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createArtifact(groupId: string, body: File, xRegistryArtifactType?: string, xRegistryArtifactId?: string, xRegistryVersion?: string, ifExists?: IfExists, canonical?: boolean, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryContentHash?: string, xRegistryHashAlgorithm?: CreateArtifactXRegistryHashAlgorithmEnum, xRegistryArtifactBranches?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactMetaData>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createArtifact(groupId, body, xRegistryArtifactType, xRegistryArtifactId, xRegistryVersion, ifExists, canonical, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryName, xRegistryNameEncoded, xRegistryContentHash, xRegistryHashAlgorithm, xRegistryArtifactBranches, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.createArtifact']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes an artifact completely, resulting in all versions of the artifact also being deleted.  This may fail for one of the following reasons:  * No artifact with the `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
        ...
        async deleteArtifact(groupId: string, artifactId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.deleteArtifact']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes all of the artifacts that exist in a given group.
        ...
        async deleteArtifactsInGroup(groupId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.deleteArtifactsInGroup']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the content for an artifact version in the registry using its globally unique identifier.  This operation may fail for one of the following reasons:  * No artifact version with this `globalId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getContentByGlobalId(globalId: number, references?: HandleReferencesType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.getContentByGlobalId']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the content for an artifact version in the registry using the  SHA-256 hash of the content.  This content hash may be shared by multiple artifact versions in the case where the artifact versions have identical content.  This operation may fail for one of the following reasons:  * No content with this `contentHash` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getContentByHash(contentHash: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.getContentByHash']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the content for an artifact version in the registry using the unique content identifier for that content.  This content ID may be shared by multiple artifact versions in the case where the artifact versions are identical.  This operation may fail for one of the following reasons:  * No content with this `contentId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getContentById(contentId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.getContentById']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns the latest version of the artifact in its raw form.  The `Content-Type` of the response depends on the artifact type.  In most cases, this is `application/json`, but  for some types it may be different (for example, `PROTOBUF`). If the latest version of the artifact is marked as `DISABLED`, the next available non-disabled version will be used.  This operation may fail for one of the following reasons:  * No artifact with this `artifactId` exists or all versions are `DISABLED` (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async getLatestArtifact(groupId: string, artifactId: string, references?: HandleReferencesType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLatestArtifact(groupId, artifactId, references, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.getLatestArtifact']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list of all artifacts in the group.  This list is paged.
         ...
         * @throws {RequiredError}
         */
        async listArtifactsInGroup(groupId: string, limit?: number, offset?: number, order?: SortOrder, orderby?: SortBy, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactSearchResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listArtifactsInGroup(groupId, limit, offset, order, orderby, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.listArtifactsInGroup']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list containing all the artifact references using the artifact content hash.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`) 
        ...
        async referencesByContentHash(contentHash: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactReference>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.referencesByContentHash']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list containing all the artifact references using the artifact content ID.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`)
        ...
        async referencesByContentId(contentId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactReference>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.referencesByContentId']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list containing all the artifact references using the artifact global ID.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`)
        ...
        async referencesByGlobalId(globalId: number, refType?: ReferenceType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactReference>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.referencesByGlobalId']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a paginated list of all artifacts that match the provided filter criteria. 
         ...
         * @throws {RequiredError}
         */
        async searchArtifacts(name?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: SortBy, labels?: Array<string>, properties?: Array<string>, description?: string, group?: string, globalId?: number, contentId?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactSearchResults>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.searchArtifacts']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a paginated list of all artifacts with at least one version that matches the posted content. 
         ...
         * @throws {RequiredError}
         */
        async searchArtifactsByContent(body: File, canonical?: boolean, artifactType?: string, offset?: number, limit?: number, order?: SearchArtifactsByContentOrderEnum, orderby?: SearchArtifactsByContentOrderbyEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactSearchResults>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.searchArtifactsByContent']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates an artifact by uploading new content.  The body of the request can be the raw content of the artifact or a JSON object containing both the raw content and a set of references to other artifacts..  This is typically in JSON format for *most* of the supported types, but may be in another format for a few (for example, `PROTOBUF`). The type of the content should be compatible with the artifact\'s type (it would be an error to update an `AVRO` artifact with new `OPENAPI` content, for example).  The update could fail for a number of reasons including:  * Provided content (request body) was empty (HTTP error `400`) * No artifact with the `artifactId` exists (HTTP error `404`) * The new content violates one of the rules configured for the artifact (HTTP error `409`) * A server error occurred (HTTP error `500`)  When successful, this creates a new version of the artifact, making it the most recent (and therefore official) version of the artifact.
         ...
         * @throws {RequiredError}
         */
        async updateArtifact(groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryArtifactBranches?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactMetaData>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateArtifact(groupId, artifactId, body, xRegistryVersion, xRegistryName, xRegistryNameEncoded, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryArtifactBranches, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.updateArtifact']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the state of the artifact.  For example, you can use this to mark the latest version of an artifact as `DEPRECATED`. The operation changes the state of the latest version of the artifact, even if this version is `DISABLED`. If multiple versions exist, only the most recent is changed.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async updateArtifactState(groupId: string, artifactId: string, updateState: UpdateState, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateArtifactState(groupId, artifactId, updateState, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['ArtifactsApi.updateArtifactState']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const ArtifactsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createArtifact(groupId: string, body: File, xRegistryArtifactType?: string, xRegistryArtifactId?: string, xRegistryVersion?: string, ifExists?: IfExists, canonical?: boolean, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryContentHash?: string, xRegistryHashAlgorithm?: CreateArtifactXRegistryHashAlgorithmEnum, xRegistryArtifactBranches?: Array<string>, options?: any): AxiosPromise<ArtifactMetaData> {
            return localVarFp.createArtifact(groupId, body, xRegistryArtifactType, xRegistryArtifactId, xRegistryVersion, ifExists, canonical, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryName, xRegistryNameEncoded, xRegistryContentHash, xRegistryHashAlgorithm, xRegistryArtifactBranches, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes an artifact completely, resulting in all versions of the artifact also being deleted.  This may fail for one of the following reasons:  * No artifact with the `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
         * @summary Delete artifact
         ...
         * @throws {RequiredError}
         */
        updateArtifact(groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryArtifactBranches?: Array<string>, options?: any): AxiosPromise<ArtifactMetaData> {
            return localVarFp.updateArtifact(groupId, artifactId, body, xRegistryVersion, xRegistryName, xRegistryNameEncoded, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryArtifactBranches, options).then((request) => request(axios, basePath));
        },
        /**
         * Updates the state of the artifact.  For example, you can use this to mark the latest version of an artifact as `DEPRECATED`. The operation changes the state of the latest version of the artifact, even if this version is `DISABLED`. If multiple versions exist, only the most recent is changed.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         * @summary Update artifact state
...
export class ArtifactsApi extends BaseAPI {
     ...
     */
    public createArtifact(groupId: string, body: File, xRegistryArtifactType?: string, xRegistryArtifactId?: string, xRegistryVersion?: string, ifExists?: IfExists, canonical?: boolean, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryContentHash?: string, xRegistryHashAlgorithm?: CreateArtifactXRegistryHashAlgorithmEnum, xRegistryArtifactBranches?: Array<string>, options?: RawAxiosRequestConfig) {
        return ArtifactsApiFp(this.configuration).createArtifact(groupId, body, xRegistryArtifactType, xRegistryArtifactId, xRegistryVersion, ifExists, canonical, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryName, xRegistryNameEncoded, xRegistryContentHash, xRegistryHashAlgorithm, xRegistryArtifactBranches, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ArtifactsApi
     */
    public getLatestArtifact(groupId: string, artifactId: string, references?: HandleReferencesType, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactsApi
     */
    public listArtifactsInGroup(groupId: string, limit?: number, offset?: number, order?: SortOrder, orderby?: SortBy, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactsApi
     */
    public searchArtifacts(name?: string, offset?: number, limit?: number, order?: SortOrder, orderby?: SortBy, labels?: Array<string>, properties?: Array<string>, description?: string, group?: string, globalId?: number, contentId?: number, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactsApi
     */
    public searchArtifactsByContent(body: File, canonical?: boolean, artifactType?: string, offset?: number, limit?: number, order?: SearchArtifactsByContentOrderEnum, orderby?: SearchArtifactsByContentOrderbyEnum, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ArtifactsApi
     */
    public updateArtifact(groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryNameEncoded?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryArtifactBranches?: Array<string>, options?: RawAxiosRequestConfig) {
        return ArtifactsApiFp(this.configuration).updateArtifact(groupId, artifactId, body, xRegistryVersion, xRegistryName, xRegistryNameEncoded, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryArtifactBranches, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ArtifactsApi
     */
    public updateArtifactState(groupId: string, artifactId: string, updateState: UpdateState, options?: RawAxiosRequestConfig) {
...
export const BranchesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createOrReplaceArtifactBranch: async (groupId: string, artifactId: string, branchId: string, artifactBranch: ArtifactBranch, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(artifactBranch, localVarRequestOptions, configuration)
         ...
         * @summary Add a new version to an artifact branch. Branch is created if it does not exist.
         * @param {string} groupId The artifact group ID.  Must be a string provided by the client, representing the name of the grouping of artifacts. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {string} artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {string} branchId Artifact branch ID.  Must follow the \&quot;[a-zA-Z0-9._\\\\-+]{1,256}\&quot; pattern.
         * @param {string} body 
         ...
         * @throws {RequiredError}
         */
        createOrUpdateArtifactBranch: async (groupId: string, artifactId: string, branchId: string, body: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            assertParamExists('createOrUpdateArtifactBranch', 'groupId', groupId)
            // verify required parameter 'artifactId' is not null or undefined
            assertParamExists('createOrUpdateArtifactBranch', 'artifactId', artifactId)
            // verify required parameter 'branchId' is not null or undefined
            assertParamExists('createOrUpdateArtifactBranch', 'branchId', branchId)
            // verify required parameter 'body' is not null or undefined
            assertParamExists('createOrUpdateArtifactBranch', 'body', body)
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/branches/{branchId}`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
                .replace(`{${"branchId"}}`, encodeURIComponent(String(branchId)));
         ...
         * @summary Delete artifact branch.
         * @param {string} groupId The artifact group ID.  Must be a string provided by the client, representing the name of the grouping of artifacts. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {string} artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {string} branchId Artifact branch ID.  Must follow the \&quot;[a-zA-Z0-9._\\\\-+]{1,256}\&quot; pattern.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteArtifactBranch: async (groupId: string, artifactId: string, branchId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            assertParamExists('deleteArtifactBranch', 'groupId', groupId)
            // verify required parameter 'artifactId' is not null or undefined
            assertParamExists('deleteArtifactBranch', 'artifactId', artifactId)
            // verify required parameter 'branchId' is not null or undefined
            assertParamExists('deleteArtifactBranch', 'branchId', branchId)
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/branches/{branchId}`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
                .replace(`{${"branchId"}}`, encodeURIComponent(String(branchId)));
         ...
         * @summary List versions in an artifact branch
         * @param {string} groupId The artifact group ID.  Must be a string provided by the client, representing the name of the grouping of artifacts. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {string} artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {string} branchId Artifact branch ID.  Must follow the \&quot;[a-zA-Z0-9._\\\\-+]{1,256}\&quot; pattern.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getArtifactBranch: async (groupId: string, artifactId: string, branchId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            assertParamExists('getArtifactBranch', 'groupId', groupId)
            // verify required parameter 'artifactId' is not null or undefined
            assertParamExists('getArtifactBranch', 'artifactId', artifactId)
            // verify required parameter 'branchId' is not null or undefined
            assertParamExists('getArtifactBranch', 'branchId', branchId)
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/branches/{branchId}`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
                .replace(`{${"branchId"}}`, encodeURIComponent(String(branchId)));
        ...
        /**
         * Returns a list of all branches in the artifact. Each branch is a list of version identifiers, ordered from the latest (tip of the branch) to the oldest.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         * @summary List artifact branches
         * @param {string} groupId The artifact group ID.  Must be a string provided by the client, representing the name of the grouping of artifacts. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {string} artifactId The artifact ID.  Can be a string (client-provided) or UUID (server-generated), representing the unique artifact identifier. Must follow the \&quot;.{1,512}\&quot; pattern.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listArtifactBranches: async (groupId: string, artifactId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            assertParamExists('listArtifactBranches', 'groupId', groupId)
            // verify required parameter 'artifactId' is not null or undefined
            assertParamExists('listArtifactBranches', 'artifactId', artifactId)
...
export const BranchesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createOrReplaceArtifactBranch(groupId: string, artifactId: string, branchId: string, artifactBranch: ArtifactBranch, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactBranch>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createOrReplaceArtifactBranch(groupId, artifactId, branchId, artifactBranch, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['BranchesApi.createOrReplaceArtifactBranch']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Add a new version to an artifact branch. Branch is created if it does not exist. Returns a list of version identifiers in the artifact branch, ordered from the latest (tip of the branch) to the oldest. This operation can fail for the following reasons: * No group with this `groupId` exists (HTTP error `404`) * No artifact with this `artifactId` exists (HTTP error `404`) * No branch with this `branchId` exists (HTTP error `404`) * Version does not exist (HTTP error `409`) * Branch already contains given version. Artifact branches are append-only, cycles and history rewrites, except by replacing the entire branch using createOrReplaceArtifactBranch operation,  are not supported. (HTTP error `409`) * A server error occurred  
         ...
         * @throws {RequiredError}
         */
        async createOrUpdateArtifactBranch(groupId: string, artifactId: string, branchId: string, body: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactBranch>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createOrUpdateArtifactBranch(groupId, artifactId, branchId, body, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['BranchesApi.createOrUpdateArtifactBranch']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes a single branch in the artifact. Any artifact versions that are not referenced by a branch are deleted as well, however, this does not happen until deletion of the \"latest\" branch is supported. This operation can fail for the following reasons: * No group with this `groupId` exists (HTTP error `404`) * No artifact with this `artifactId` exists (HTTP error `404`) * No branch with this `branchId` exists (HTTP error `404`) * Deletion of the \"latest\" branch is not supported (HTTP error `409`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async deleteArtifactBranch(groupId: string, artifactId: string, branchId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteArtifactBranch(groupId, artifactId, branchId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['BranchesApi.deleteArtifactBranch']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list of version identifiers in the artifact branch, ordered from the latest (tip of the branch) to the oldest.  This operation can fail for the following reasons:  * No group with this `groupId` exists (HTTP error `404`) * No artifact with this `artifactId` exists (HTTP error `404`) * No branch with this `branchId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async getArtifactBranch(groupId: string, artifactId: string, branchId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactBranch>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getArtifactBranch(groupId, artifactId, branchId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['BranchesApi.getArtifactBranch']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list of all branches in the artifact. Each branch is a list of version identifiers, ordered from the latest (tip of the branch) to the oldest.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async listArtifactBranches(groupId: string, artifactId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactBranch>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listArtifactBranches(groupId, artifactId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['BranchesApi.listArtifactBranches']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const BranchesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createOrReplaceArtifactBranch(groupId: string, artifactId: string, branchId: string, artifactBranch: ArtifactBranch, options?: any): AxiosPromise<ArtifactBranch> {
            return localVarFp.createOrReplaceArtifactBranch(groupId, artifactId, branchId, artifactBranch, options).then((request) => request(axios, basePath));
        },
        /**
         * Add a new version to an artifact branch. Branch is created if it does not exist. Returns a list of version identifiers in the artifact branch, ordered from the latest (tip of the branch) to the oldest. This operation can fail for the following reasons: * No group with this `groupId` exists (HTTP error `404`) * No artifact with this `artifactId` exists (HTTP error `404`) * No branch with this `branchId` exists (HTTP error `404`) * Version does not exist (HTTP error `409`) * Branch already contains given version. Artifact branches are append-only, cycles and history rewrites, except by replacing the entire branch using createOrReplaceArtifactBranch operation,  are not supported. (HTTP error `409`) * A server error occurred  
         * @summary Add a new version to an artifact branch. Branch is created if it does not exist.
         ...
         * @throws {RequiredError}
         */
        createOrUpdateArtifactBranch(groupId: string, artifactId: string, branchId: string, body: string, options?: any): AxiosPromise<ArtifactBranch> {
            return localVarFp.createOrUpdateArtifactBranch(groupId, artifactId, branchId, body, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes a single branch in the artifact. Any artifact versions that are not referenced by a branch are deleted as well, however, this does not happen until deletion of the \"latest\" branch is supported. This operation can fail for the following reasons: * No group with this `groupId` exists (HTTP error `404`) * No artifact with this `artifactId` exists (HTTP error `404`) * No branch with this `branchId` exists (HTTP error `404`) * Deletion of the \"latest\" branch is not supported (HTTP error `409`) * A server error occurred (HTTP error `500`) 
         * @summary Delete artifact branch.
         ...
         * @throws {RequiredError}
         */
        deleteArtifactBranch(groupId: string, artifactId: string, branchId: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteArtifactBranch(groupId, artifactId, branchId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list of version identifiers in the artifact branch, ordered from the latest (tip of the branch) to the oldest.  This operation can fail for the following reasons:  * No group with this `groupId` exists (HTTP error `404`) * No artifact with this `artifactId` exists (HTTP error `404`) * No branch with this `branchId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         * @summary List versions in an artifact branch
         ...
         * @throws {RequiredError}
         */
        getArtifactBranch(groupId: string, artifactId: string, branchId: string, options?: any): AxiosPromise<ArtifactBranch> {
            return localVarFp.getArtifactBranch(groupId, artifactId, branchId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list of all branches in the artifact. Each branch is a list of version identifiers, ordered from the latest (tip of the branch) to the oldest.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         * @summary List artifact branches
         ...
         * @throws {RequiredError}
         */
        listArtifactBranches(groupId: string, artifactId: string, options?: any): AxiosPromise<Array<ArtifactBranch>> {
            return localVarFp.listArtifactBranches(groupId, artifactId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BranchesApi extends BaseAPI {
     ...
     */
    public createOrReplaceArtifactBranch(groupId: string, artifactId: string, branchId: string, artifactBranch: ArtifactBranch, options?: RawAxiosRequestConfig) {
        return BranchesApiFp(this.configuration).createOrReplaceArtifactBranch(groupId, artifactId, branchId, artifactBranch, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BranchesApi
     */
    public createOrUpdateArtifactBranch(groupId: string, artifactId: string, branchId: string, body: string, options?: RawAxiosRequestConfig) {
        return BranchesApiFp(this.configuration).createOrUpdateArtifactBranch(groupId, artifactId, branchId, body, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BranchesApi
     */
    public deleteArtifactBranch(groupId: string, artifactId: string, branchId: string, options?: RawAxiosRequestConfig) {
        return BranchesApiFp(this.configuration).deleteArtifactBranch(groupId, artifactId, branchId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BranchesApi
     */
    public getArtifactBranch(groupId: string, artifactId: string, branchId: string, options?: RawAxiosRequestConfig) {
        return BranchesApiFp(this.configuration).getArtifactBranch(groupId, artifactId, branchId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BranchesApi
     */
    public listArtifactBranches(groupId: string, artifactId: string, options?: RawAxiosRequestConfig) {
        return BranchesApiFp(this.configuration).listArtifactBranches(groupId, artifactId, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const GroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createGroup: async (createGroupMetaData: CreateGroupMetaData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listGroups: async (limit?: number, offset?: number, order?: SortOrder, orderby?: SortBy, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/groups`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const GroupsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createGroup(createGroupMetaData: CreateGroupMetaData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GroupMetaData>> {
        ...
        async deleteGroupById(groupId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['GroupsApi.deleteGroupById']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a group using the specified id.  This operation can fail for the following reasons:  * No group exists with the specified ID (HTTP error `404`) * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async listGroups(limit?: number, offset?: number, order?: SortOrder, orderby?: SortBy, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GroupSearchResults>> {
...
export class GroupsApi extends BaseAPI {
     ...
     * @memberof GroupsApi
     */
    public createGroup(createGroupMetaData: CreateGroupMetaData, options?: RawAxiosRequestConfig) {
     ...
     * @memberof GroupsApi
     */
    public listGroups(limit?: number, offset?: number, order?: SortOrder, orderby?: SortBy, options?: RawAxiosRequestConfig) {
...
export const MetadataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteArtifactVersionMetaData: async (groupId: string, artifactId: string, versionExpression: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            ...
            assertParamExists('deleteArtifactVersionMetaData', 'versionExpression', versionExpression)
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/versions/{versionExpression}/meta`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
         ...
         * @throws {RequiredError}
         */
        getArtifactOwner: async (groupId: string, artifactId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getArtifactVersionMetaDataByContent: async (groupId: string, artifactId: string, body: File, canonical?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifactMetaData: async (groupId: string, artifactId: string, editableMetaData: EditableMetaData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifactOwner: async (groupId: string, artifactId: string, artifactOwner: ArtifactOwner, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifactVersionMetaData: async (groupId: string, artifactId: string, versionExpression: string, editableMetaData: EditableMetaData, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
...
export const MetadataApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteArtifactVersionMetaData(groupId: string, artifactId: string, versionExpression: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteArtifactVersionMetaData(groupId, artifactId, versionExpression, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.deleteArtifactVersionMetaData']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the metadata for an artifact in the registry, based on the latest version. If the latest version of the artifact is marked as `DISABLED`, the next available non-disabled version will be used. The returned metadata includes both generated (read-only) and editable metadata (such as name and description).  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists  or all versions are `DISABLED` (HTTP error `404`) * A server error occurred (HTTP error `500`)
        ...
        async getArtifactMetaData(groupId: string, artifactId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactMetaData>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.getArtifactMetaData']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the owner of an artifact in the registry.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async getArtifactOwner(groupId: string, artifactId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtifactOwner>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getArtifactOwner(groupId, artifactId, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.getArtifactOwner']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Retrieves the metadata for a single version of the artifact.  The version metadata is  a subset of the artifact metadata and only includes the metadata that is specific to the version (for example, this doesn\'t include `modifiedOn`).  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getArtifactVersionMetaData(groupId: string, artifactId: string, versionExpression: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VersionMetaData>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.getArtifactVersionMetaData']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Gets the metadata for an artifact that matches the raw content.  Searches the registry for a version of the given artifact matching the content provided in the body of the POST.  This operation can fail for the following reasons:  * Provided content (request body) was empty (HTTP error `400`) * No artifact with the `artifactId` exists (HTTP error `404`) * No artifact version matching the provided content exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async getArtifactVersionMetaDataByContent(groupId: string, artifactId: string, body: File, canonical?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VersionMetaData>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.getArtifactVersionMetaDataByContent']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the editable parts of the artifact\'s metadata.  Not all metadata fields can be updated.  For example, `createdOn` and `createdBy` are both read-only properties.  This operation can fail for the following reasons:  * No artifact with the `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async updateArtifactMetaData(groupId: string, artifactId: string, editableMetaData: EditableMetaData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.updateArtifactMetaData']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Changes the ownership of an artifact.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async updateArtifactOwner(groupId: string, artifactId: string, artifactOwner: ArtifactOwner, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateArtifactOwner(groupId, artifactId, artifactOwner, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.updateArtifactOwner']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the user-editable portion of the artifact version\'s metadata.  Only some of  the metadata fields are editable by the user.  For example, `description` is editable,  but `createdOn` is not.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async updateArtifactVersionMetaData(groupId: string, artifactId: string, versionExpression: string, editableMetaData: EditableMetaData, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateArtifactVersionMetaData(groupId, artifactId, versionExpression, editableMetaData, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MetadataApi.updateArtifactVersionMetaData']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const MetadataApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteArtifactVersionMetaData(groupId: string, artifactId: string, versionExpression: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteArtifactVersionMetaData(groupId, artifactId, versionExpression, options).then((request) => request(axios, basePath));
        },
        /**
         * Gets the metadata for an artifact in the registry, based on the latest version. If the latest version of the artifact is marked as `DISABLED`, the next available non-disabled version will be used. The returned metadata includes both generated (read-only) and editable metadata (such as name and description).  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists  or all versions are `DISABLED` (HTTP error `404`) * A server error occurred (HTTP error `500`)
         * @summary Get artifact metadata
         ...
         * @throws {RequiredError}
         */
        updateArtifactVersionMetaData(groupId: string, artifactId: string, versionExpression: string, editableMetaData: EditableMetaData, options?: any): AxiosPromise<void> {
            return localVarFp.updateArtifactVersionMetaData(groupId, artifactId, versionExpression, editableMetaData, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class MetadataApi extends BaseAPI {
     ...
     */
    public deleteArtifactVersionMetaData(groupId: string, artifactId: string, versionExpression: string, options?: RawAxiosRequestConfig) {
        return MetadataApiFp(this.configuration).deleteArtifactVersionMetaData(groupId, artifactId, versionExpression, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof MetadataApi
     */
    public getArtifactOwner(groupId: string, artifactId: string, options?: RawAxiosRequestConfig) {
     ...
     * @memberof MetadataApi
     */
    public getArtifactVersionMetaDataByContent(groupId: string, artifactId: string, body: File, canonical?: boolean, options?: RawAxiosRequestConfig) {
     ...
     * @memberof MetadataApi
     */
    public updateArtifactMetaData(groupId: string, artifactId: string, editableMetaData: EditableMetaData, options?: RawAxiosRequestConfig) {
     ...
     * @memberof MetadataApi
     */
    public updateArtifactOwner(groupId: string, artifactId: string, artifactOwner: ArtifactOwner, options?: RawAxiosRequestConfig) {
     ...
     * @memberof MetadataApi
     */
    public updateArtifactVersionMetaData(groupId: string, artifactId: string, versionExpression: string, editableMetaData: EditableMetaData, options?: RawAxiosRequestConfig) {
        return MetadataApiFp(this.configuration).updateArtifactVersionMetaData(groupId, artifactId, versionExpression, editableMetaData, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const SystemApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getResourceLimits(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Limits>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['SystemApi.getResourceLimits']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * This operation retrieves information about the running registry system, such as the version of the software and when it was built.
        ...
        async getSystemInfo(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SystemInfo>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['SystemApi.getSystemInfo']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const UsersApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getCurrentUserInfo(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserInfo>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['UsersApi.getCurrentUserInfo']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const VersionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createArtifactVersion: async (groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryNameEncoded?: string, xRegistryArtifactBranches?: Array<string>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getArtifactVersion: async (groupId: string, artifactId: string, versionExpression: string, references?: HandleReferencesType, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            assertParamExists('getArtifactVersion', 'groupId', groupId)
            // verify required parameter 'artifactId' is not null or undefined
            assertParamExists('getArtifactVersion', 'artifactId', artifactId)
            // verify required parameter 'versionExpression' is not null or undefined
            assertParamExists('getArtifactVersion', 'versionExpression', versionExpression)
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/versions/{versionExpression}`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
                .replace(`{${"versionExpression"}}`, encodeURIComponent(String(versionExpression)));
         ...
         * @throws {RequiredError}
         */
        listArtifactVersions: async (groupId: string, artifactId: string, offset?: number, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifactVersionState: async (groupId: string, artifactId: string, versionExpression: string, updateState: UpdateState, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'groupId' is not null or undefined
            ...
            // verify required parameter 'versionExpression' is not null or undefined
            assertParamExists('updateArtifactVersionState', 'versionExpression', versionExpression)
            // verify required parameter 'updateState' is not null or undefined
            assertParamExists('updateArtifactVersionState', 'updateState', updateState)
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/versions/{versionExpression}/state`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
                .replace(`{${"versionExpression"}}`, encodeURIComponent(String(versionExpression)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const VersionsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async addArtifactVersionComment(groupId: string, artifactId: string, versionExpression: string, newComment: NewComment, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Comment>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.addArtifactVersionComment']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Creates a new version of the artifact by uploading new content.  The configured rules for the artifact are applied, and if they all pass, the new content is added as the most recent  version of the artifact.  If any of the rules fail, an error is returned.  The body of the request can be the raw content of the new artifact version, or the raw content  and a set of references pointing to other artifacts, and the type of that content should match the artifact\'s type (for example if the artifact type is `AVRO` then the content of the request should be an Apache Avro document).  This operation can fail for the following reasons:  * Provided content (request body) was empty (HTTP error `400`) * No artifact with this `artifactId` exists (HTTP error `404`) * The new content violates one of the rules configured for the artifact (HTTP error `409`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async createArtifactVersion(groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryNameEncoded?: string, xRegistryArtifactBranches?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VersionMetaData>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createArtifactVersion(groupId, artifactId, body, xRegistryVersion, xRegistryName, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryNameEncoded, xRegistryArtifactBranches, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.createArtifactVersion']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes a single version of the artifact. Parameters `groupId`, `artifactId` and the unique `version` are needed. If this is the only version of the artifact, this operation is the same as  deleting the entire artifact.  This feature is disabled by default and it\'s discouraged for normal usage. To enable it, set the `registry.rest.artifact.deletion.enabled` property to true. This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`)  * Feature is disabled (HTTP error `405`)  * A server error occurred (HTTP error `500`) 
        ...
        async deleteArtifactVersion(groupId: string, artifactId: string, versionExpression: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.deleteArtifactVersion']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Deletes a single comment in an artifact version.  Only the owner of the comment can delete it.  The `artifactId`, unique `version` number, and `commentId`  must be provided.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * No comment with this `commentId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async deleteArtifactVersionComment(groupId: string, artifactId: string, versionExpression: string, commentId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.deleteArtifactVersionComment']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Retrieves a single version of the artifact content.  Both the `artifactId` and the unique `version` number must be provided.  The `Content-Type` of the response depends  on the artifact type.  In most cases, this is `application/json`, but for some types  it may be different (for example, `PROTOBUF`).  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async getArtifactVersion(groupId: string, artifactId: string, versionExpression: string, references?: HandleReferencesType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getArtifactVersion(groupId, artifactId, versionExpression, references, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.getArtifactVersion']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Retrieves all comments for a version of an artifact.  Both the `artifactId` and the unique `version` number must be provided.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getArtifactVersionComments(groupId: string, artifactId: string, versionExpression: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Comment>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.getArtifactVersionComments']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Retrieves all references for a single version of an artifact.  Both the `artifactId` and the unique `version` number must be provided.  Using the `refType` query parameter, it is possible to retrieve an array of either the inbound or outbound references.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async getArtifactVersionReferences(groupId: string, artifactId: string, versionExpression: string, refType?: ReferenceType, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactReference>>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.getArtifactVersionReferences']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Returns a list of all versions of the artifact.  The result set is paged.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async listArtifactVersions(groupId: string, artifactId: string, offset?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VersionSearchResults>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listArtifactVersions(groupId, artifactId, offset, limit, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.listArtifactVersions']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the value of a single comment in an artifact version.  Only the owner of the comment can modify it.  The `artifactId`, unique `version` number, and `commentId`  must be provided.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * No comment with this `commentId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
        ...
        async updateArtifactVersionComment(groupId: string, artifactId: string, versionExpression: string, commentId: string, newComment: NewComment, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.updateArtifactVersionComment']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the state of a specific version of an artifact.  For example, you can use  this operation to disable a specific version.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         ...
         * @throws {RequiredError}
         */
        async updateArtifactVersionState(groupId: string, artifactId: string, versionExpression: string, updateState: UpdateState, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateArtifactVersionState(groupId, artifactId, versionExpression, updateState, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['VersionsApi.updateArtifactVersionState']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const VersionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createArtifactVersion(groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryNameEncoded?: string, xRegistryArtifactBranches?: Array<string>, options?: any): AxiosPromise<VersionMetaData> {
            return localVarFp.createArtifactVersion(groupId, artifactId, body, xRegistryVersion, xRegistryName, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryNameEncoded, xRegistryArtifactBranches, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes a single version of the artifact. Parameters `groupId`, `artifactId` and the unique `version` are needed. If this is the only version of the artifact, this operation is the same as  deleting the entire artifact.  This feature is disabled by default and it\'s discouraged for normal usage. To enable it, set the `registry.rest.artifact.deletion.enabled` property to true. This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`)  * Feature is disabled (HTTP error `405`)  * A server error occurred (HTTP error `500`) 
         * @summary Delete artifact version
         ...
         * @throws {RequiredError}
         */
        getArtifactVersion(groupId: string, artifactId: string, versionExpression: string, references?: HandleReferencesType, options?: any): AxiosPromise<File> {
            return localVarFp.getArtifactVersion(groupId, artifactId, versionExpression, references, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieves all comments for a version of an artifact.  Both the `artifactId` and the unique `version` number must be provided.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`) 
         * @summary Get artifact version comments
         ...
         * @throws {RequiredError}
         */
        updateArtifactVersionState(groupId: string, artifactId: string, versionExpression: string, updateState: UpdateState, options?: any): AxiosPromise<void> {
            return localVarFp.updateArtifactVersionState(groupId, artifactId, versionExpression, updateState, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class VersionsApi extends BaseAPI {
     ...
     * @memberof VersionsApi
     */
    public createArtifactVersion(groupId: string, artifactId: string, body: File, xRegistryVersion?: string, xRegistryName?: string, xRegistryDescription?: string, xRegistryDescriptionEncoded?: string, xRegistryNameEncoded?: string, xRegistryArtifactBranches?: Array<string>, options?: RawAxiosRequestConfig) {
        return VersionsApiFp(this.configuration).createArtifactVersion(groupId, artifactId, body, xRegistryVersion, xRegistryName, xRegistryDescription, xRegistryDescriptionEncoded, xRegistryNameEncoded, xRegistryArtifactBranches, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VersionsApi
     */
    public getArtifactVersion(groupId: string, artifactId: string, versionExpression: string, references?: HandleReferencesType, options?: RawAxiosRequestConfig) {
        return VersionsApiFp(this.configuration).getArtifactVersion(groupId, artifactId, versionExpression, references, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof VersionsApi
     */
    public listArtifactVersions(groupId: string, artifactId: string, offset?: number, limit?: number, options?: RawAxiosRequestConfig) {
     ...
     * @memberof VersionsApi
     */
    public updateArtifactVersionState(groupId: string, artifactId: string, versionExpression: string, updateState: UpdateState, options?: RawAxiosRequestConfig) {
        return VersionsApiFp(this.configuration).updateArtifactVersionState(groupId, artifactId, versionExpression, updateState, options).then((request) => request(this.axios, this.basePath));
    }
}
